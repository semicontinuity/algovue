test = function() {
                ...
                vm.sequenceStatement([
                    vm.group('// Consume char 1 of pattern','#FFFFF0', 'FFFFD0',
                        [
                            vm.assignment(
                                vm.varWrite('c1'),
                                vm.arrItem('a', vm.varPostOp('i', true))
                            ),
                            vm.ifStatement(
                                ...
                                vm.sequenceStatement([
                                    vm.group(undefined,'#FFFFF0', 'FFD0D0',
                                        [
                                            vm.assignment(
                                                undefined,
                                                vm.functionCall('push', [vm.variable('c1')], 'result')
                                            ),
                                ...
                                vm.sequenceStatement([
                                    vm.group(undefined,'#F0FFF0', 'FFD0D0',
                                        [
                                            ...
                                            vm.assignment(
                                                undefined,
                                                vm.functionCall('push', [vm.variable('c2')], 'result')
                                            ),
                                            vm.continueStatement()
                                        ])
                                ]),
                                ...
                                vm.sequenceStatement([
                                    vm.group(undefined,'#F0F8FF', 'FFD0D0',
                                        [
                                            ...
                                            vm.assignment(
                                                undefined,
                                                vm.functionCall('push', [vm.variable('c3')], 'result')
                                            ),
                                            vm.continueStatement()
                                        ])
                                ]),
    ...
    const usage = vm.sequenceStatement([
        vm.assignment(
            vm.varWrite('result'),
            vm.functionCall(deleteSmiles, [vm.string('Hi:-)) :-)_:-(( :)'), vm.number(18)])
        ),
        vm.stop()
    ]);
